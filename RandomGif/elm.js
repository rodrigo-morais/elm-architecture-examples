...
Elm.RandomGif.make = function (_elm) {
   ...
   var decodeImageUrl = A2($Json$Decode.at,_U.list(["data","image_url"]),$Json$Decode.string);
   ...
   var getRandomGif = function (topic) {    return $Effects.task(A2($Task.map,NewGif,$Task.toMaybe(A2($Http.get,decodeImageUrl,randomUrl(topic)))));};
